            ...
            <div class="card-body">
                ...
                <form action="{{ route('register.submit') }}" method="post">
                    ...
                    <div class="input-group mb-3">
                        <input name="firstname" type="text" class="form-control @error('firstname') is-invalid @enderror" placeholder="First Name">
                    ...
                    <div class="input-group mb-3">
                        <input name="lastname" type="text" class="form-control @error('lastname') is-invalid @enderror" placeholder="Last Name">
                        <div class="input-group-append">
                            <div class="input-group-text">
                                <span class="fas fa-user"></span>
                            </div>
